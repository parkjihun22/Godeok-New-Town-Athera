...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `고덕신도시 핵심 입지`,
    text2: `A-63BL 중심 입지<br/>
            고덕신도시 아테라가 누리는 미래가치 프리미엄`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망 프리미엄`,
    text2: `수도권 접근성이 우수한 광역 교통 환경<br/>
            편리한 이동을 누리는 고덕신도시 아테라`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `풍부한 생활 인프라`,
    text2: `상업시설 · 교육환경 · 생활편의시설<br/>
            완성형 신도시 생활권을 누리는 주거 환경`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
...
<div className={styles.imageContainer}>
  <img
    ...
    alt="고덕신도시 아테라 평택 고덕국제화계획지구 A-63BL 메인 이미지"
  />
  ...
  <div className={styles.mainImageTextBox}>
    ...
    <div className={styles.mainImageTitleBox}>
      ...
      <div className={styles.mainImageDesc}>
        평택 고덕국제신도시 중심에서 누리는 브랜드 프리미엄<br />
        삼성 평택캠퍼스와 함께하는 미래가치 주거단지<br />
        고덕신도시 아테라가 제안하는 새로운 라이프스타일
      </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 평택 고덕국제화계획지구 A-63BL 핵심 입지 프리미엄<br />
                  - 금호건설 아테라 브랜드가 선사하는 차별화된 주거 가치<br />
                  - 삼성 평택캠퍼스 직주근접으로 높아지는 미래가치 기대<br />
                  - 교육·상업·공원·생활 인프라를 가까이 누리는 완성형 신도시 생활권<br />
                  - 전용 74㎡·84㎡ 중심 설계와 쾌적한 커뮤니티를 갖춘 프리미엄 단지
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="고덕신도시 아테라브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>고덕신도시 아테라</div>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="고덕신도시 아테라오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.mainImageTextSub1}>
            평택 고덕 A-63BL의 새로운 랜드마크<br />
            평택 고덕국제신도시 프리미엄 라이프<br />
          ...
          <div className={styles.mainImageTitleBox1}>
            ...
            <div className={styles.mainImageDesc1}>
              평택 고덕국제신도시 중심에서 누리는 브랜드 프리미엄<br />
              금호건설 아테라가 선사하는 차별화된 주거 가치<br />
              미래가치를 더하는 고덕신도시 아테라 라이프
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 고덕신도시 아테라에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="고덕신도시 아테라모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="고덕신도시 아테라브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="고덕신도시 아테라오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
