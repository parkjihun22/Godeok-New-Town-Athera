...
<Helmet>
  {/* 페이지별 메타 */}
  <title>고덕신도시 아테라 | 관심고객등록</title>

  <meta
    name="description"
    content="고덕신도시 아테라 관심고객등록 안내. 평택 고덕국제화계획지구 A-63BL 고덕신도시 아테라의 분양 정보, 청약 일정, 공급안내, 모델하우스 소식 및 주요 안내를 가장 먼저 확인하세요."
  />

  <meta
    name="keywords"
    content="고덕신도시 아테라, 고덕신도시 아테라 관심고객등록, 평택 고덕신도시 아테라, 고덕국제신도시 아테라, 고덕국제화계획지구 A-63BL, A63BL 아테라, 평택 고덕 분양, 고덕신도시 청약, 고덕신도시 모델하우스, 금호건설 아테라"
  />
  ...
  <meta
    property="og:title"
    content="고덕신도시 아테라 | 관심고객등록"
  />

  <meta
    property="og:description"
    content="고덕신도시 아테라 관심고객 등록 시 분양 일정, 청약 정보, 모델하우스 소식 및 공급안내를 우선 받아보세요."
  />
  ...
  <meta
    ...
    content="고덕신도시 아테라 관심고객 등록으로 분양 일정, 청약 정보, 공급안내 및 모델하우스 소식을 가장 먼저 확인하세요."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "name": "고덕신도시 아테라 관심고객등록",

      "url": "https://www.diarivalencia.com/Promotion/Customer",

      "description":
        "고덕신도시 아테라 관심고객등록 페이지입니다. 평택 고덕국제화계획지구 A-63BL 고덕신도시 아테라의 분양 일정, 청약 정보, 공급안내, 모델하우스 소식 등 주요 안내를 우선 제공합니다.",
